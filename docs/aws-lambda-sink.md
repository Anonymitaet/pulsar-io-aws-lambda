---
description: The AWS Lambda sink connector sends data from Pulsar topics and persists data to invoke AWS Lambda Function.
author: ["StreamNative"]
contributors: ["StreamNative"]
language: Java
document: 
source: "https://github.com/streamnative/pulsar-io-aws-lambda/tree/branch-2.7.0/src/main/java/org/apache/pulsar/ecosystem/io/aws/lambda"
...
icon: "/images/connectors/aws-lambda-logo.png"
...
| `lambdaFunctionName` | String|true | " " (empty string) | The Lambda function name that should be invoked by the messages. |
